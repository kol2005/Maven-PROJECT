...
public class EncEx_04 {
	...
	public static void main(String[] args) {
		...
		String encUser = "iOIxoGkEiZAXzqcHhLTfSA==";
		String encPassword = "iAfSbfxNy4NWjGOA15Qutw==";
		...
		/*
		 * iolist2 => iOIxoGkEiZAXzqcHhLTfSA==
		 * iolist2 => iAfSbfxNy4NWjGOA15Qutw==
		 */
	}
